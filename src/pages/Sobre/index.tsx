...
const Sobre: React.FC = () => {
  return (
    <MainTemplate title="Entenda a Técnica Pomodoro - Chronos Pomodoro">
      <Container>
        <GenericHtml>
          ...
          <p>
            ...
            trabalho em blocos de tempo (os famosos &ldquo;Pomodoros&rdquo;) intercalados
            com pausas. O objetivo é manter o foco total por um período curto e
            garantir descansos para evitar o cansaço mental.
          </p>

          <div className="relative w-full h-48 sm:h-56 md:h-72 lg:h-96 my-4 sm:my-5 md:my-6 rounded-lg overflow-hidden shadow-lg">
            <Image 
          ...
          <p>
            ...
            <Link href='/Configuracao' className="text-link-cor hover:text-link-hover underline underline-offset-4 transition-colors duration-200">
          ...
          <p>
            ...
            <Link href='/Historico' className="text-link-cor hover:text-link-hover underline underline-offset-4 transition-colors duration-200">
              histórico
            </Link>, com status de
          ...
          <p>
            ...
            <Link href='/' className="text-link-cor hover:text-link-hover underline underline-offset-4 transition-colors duration-200">
          ...
          <p>
            <em>&ldquo;Foco total, sem pressa, sem pausa, só vai!&rdquo;</em> 💪🧘‍♂️
          </p>
        </GenericHtml>
      </Container>
    </MainTemplate>
